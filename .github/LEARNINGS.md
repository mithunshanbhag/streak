...
- The deploy workflow should publish Android with `-p:AndroidPackageFormat=apk`, then upload the generated `*-Signed.apk` as an artifact so the CI output includes a sideloadable package for direct phone installs.
