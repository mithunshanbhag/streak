...
(
    ...
    CONSTRAINT UQ_Habits_DisplayOrder UNIQUE (DisplayOrder),
    CONSTRAINT CK_Habits_DisplayOrder_NonNegative CHECK (DisplayOrder >= 0)
) STRICT;
...
(
    ...
    CONSTRAINT FK_Checkins_Habits FOREIGN KEY (HabitId) REFERENCES Habits (Id)
        ON DELETE CASCADE
        ON UPDATE CASCADE,
