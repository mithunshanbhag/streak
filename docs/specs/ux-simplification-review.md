...
The current direction is already strong: one primary screen, binary check-ins, a 10-habit cap, and local-only data are all simplicity-friendly choices. The remaining opportunities are mostly about reducing **tap cost** and **visual weight**.
