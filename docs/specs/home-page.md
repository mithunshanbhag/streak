# Home Page (Landing / Checkin)

> **Route**: `/` (default landing page)

The home page is the **primary surface** of the Streak app. Users should be able to open the app, check in their habits for the day, and leave — all without navigating anywhere.

## Layout

The page displays a **vertical list of habit cards**, one per habit, in the user-defined order.
...
| Habit name     | Center-left  | The habit's name label.                                                                                                                          |
| Current streak | Center-right | A badge or label showing the streak count (e.g., "😎 3" or "🔥 12"). Tapping this navigates to the [Trends page](./trends-page.md) for that habit. |
...
- The streak count is **tappable** and navigates to the [Trends page](./trends-page.md) for that specific habit.
