...
| Create Habit                 | `/settings/habits/new`              | [create-habit-page.md](./create-habit-page.md)               | Create a new habit from the global add action or settings |
| Edit Habit                   | `/settings/habits/{habitId}/edit`   | [edit-habit-page.md](./edit-habit-page.md)                   | Update an existing habit without changing its history |
| Delete Habit Confirmation    | `/settings/habits/{habitId}/delete` | [delete-habit-page.md](./delete-habit-page.md)               | Confirm destructive habit deletion                    |
...
- Habit creation, editing, and deletion are part of the **Settings route hierarchy**, rather than separate top-level areas.
